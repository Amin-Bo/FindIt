...
class CartPage extends StatefulWidget {
  const CartPage({Key? key,required this.id,required this.idOrder,required this.name,required this.img,required this.price}) : super(key: key);
                  ...
                  children:<Widget> [
                    ...
                    Column(
                      ...
                      children:  <Widget> [
                        ...
                        Text(widget.price.toString()+ " ",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                        SizedBox(
